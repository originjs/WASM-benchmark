var Module = function (Module) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'multiplyInt.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'multiplyInt.wasm';
    var asmjsCodeFile = Module['asmjsCodeFile'] || 'multiplyInt.temp.asm.js';
  ...
  var _multiplyInt = (Module['_multiplyInt'] = function () {
    return Module['asm']['_multiplyInt'].apply(null, arguments);
  });
