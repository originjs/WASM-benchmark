var Module = (function (Module) {
    ...
    function integrateWasmJS(Module) {
        ...
        var wasmTextFile = Module["wasmTextFile"] || "collisionDetection.wast";
        var wasmBinaryFile = Module["wasmBinaryFile"] || "collisionDetection.wasm";
        var asmjsCodeFile = Module["asmjsCodeFile"] || "collisionDetection.temp.asm.js";
    ...
    __ATINIT__.push();
    memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "collisionDetection.js.mem" : null;
    var STATIC_BUMP = 8528;
    ...
    Module["asm"] = asm;
    var _collisionDetection = Module["_collisionDetection"] = (function () {
        return Module["asm"]["_collisionDetection"].apply(null, arguments)
    });
