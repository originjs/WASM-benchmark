var Module = (function (Module) {
    ...
    function integrateWasmJS(Module) {
        ...
        var wasmTextFile = Module["wasmTextFile"] || "sumInt.wast";
        var wasmBinaryFile = Module["wasmBinaryFile"] || "sumInt.wasm";
        var asmjsCodeFile = Module["asmjsCodeFile"] || "sumInt.temp.asm.js";
    ...
    __ATINIT__.push();
    memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "sumInt.js.mem" : null;
    ...
    var _sumInt = Module["_sumInt"] = (function () {
        return Module["asm"]["_sumInt"].apply(null, arguments)
    });
