var Module = function (Module) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'markerDetection.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'markerDetection.wasm';
    var asmjsCodeFile =
      Module['asmjsCodeFile'] || 'markerDetection.temp.asm.js';
  ...
  memoryInitializer =
    ...
    Module['wasmJSMethod'].indexOf('interpret-asm2wasm') >= 0
      ? 'markerDetection.js.mem'
      : null;
  var STATIC_BUMP = 8864;
  ...
  var _newARDetector = (Module['_newARDetector'] = function () {
    return Module['asm']['_newARDetector'].apply(null, arguments);
  });
  ...
  var _freeResult = (Module['_freeResult'] = function () {
    return Module['asm']['_freeResult'].apply(null, arguments);
  });
