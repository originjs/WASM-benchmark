var Module = function (Module) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'sumDouble.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'sumDouble.wasm';
    var asmjsCodeFile = Module['asmjsCodeFile'] || 'sumDouble.temp.asm.js';
  ...
  var _sumDouble = (Module['_sumDouble'] = function () {
    return Module['asm']['_sumDouble'].apply(null, arguments);
  });
