var Module = function (Module) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'multiplyDouble.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'multiplyDouble.wasm';
    var asmjsCodeFile = Module['asmjsCodeFile'] || 'multiplyDouble.temp.asm.js';
  ...
  var _multiplyDouble = (Module['_multiplyDouble'] = function () {
    return Module['asm']['_multiplyDouble'].apply(null, arguments);
  });
