var Module = function (Module) {
  ...
  function integrateWasmJS(Module) {
    ...
    var wasmTextFile = Module['wasmTextFile'] || 'multiplyDoubleVec.wast';
    var wasmBinaryFile = Module['wasmBinaryFile'] || 'multiplyDoubleVec.wasm';
    var asmjsCodeFile =
      Module['asmjsCodeFile'] || 'multiplyDoubleVec.temp.asm.js';
  ...
  var _multiplyDoubleVec = (Module['_multiplyDoubleVec'] = function () {
    return Module['asm']['_multiplyDoubleVec'].apply(null, arguments);
  });
